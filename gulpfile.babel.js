...
export const deploys = () => gulp.src('./dist/*', { read: false })
	.pipe(deploy({
		repository: 'https://gitlab.com/bunnyfresh/quickappninja.git'
	}));
...
export const prod = gulp.series(cleanFiles, smartGrid, serverConfig, views, styles, scripts, images, webpimages, fonts, favs , deploys);
